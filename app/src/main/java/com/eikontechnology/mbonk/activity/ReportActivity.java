...
import com.eikontechnology.mbonk.app.AppController;
...
public class ReportActivity extends AppCompatActivity {
    ...
    private void PostDataToServer() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.URL_REPORT, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put(Constants.JUDUL, inputJudul.getText().toString());
                params.put(Constants.ISI_LAPORAN, inputIsi.getText().toString());
                params.put(Constants.GAMBAR, imgSource);
